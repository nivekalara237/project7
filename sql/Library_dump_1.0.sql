...
CREATE TABLE `loan` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_loan_book_idx` (`id_book`),
  KEY `fk_loan_user_idx` (`id_user`),
  CONSTRAINT `fk_loan_book` FOREIGN KEY (`id_book`) REFERENCES `book` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_loan_user` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2020-07-07  9:35:52
